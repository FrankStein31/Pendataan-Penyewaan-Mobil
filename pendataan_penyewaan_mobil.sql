...
(103,31,1,100000.00,'2025-06-28 21:35:17'),
(104,31,4,10000.00,'2025-06-28 21:35:17'),
(105,31,7,20000.00,'2025-06-28 21:35:17'),
...
CREATE TABLE `driver` (
  ...
  `nama_driver` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `alamat` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `no_telp` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `no_sim` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `histori_pembayaran` (
  ...
  `id_transaksi` int NOT NULL,
  `jenis_pembayaran` enum('DP','Pelunasan','Lunas') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `jumlah` decimal(10,2) NOT NULL,
...
insert  into `histori_pembayaran`(`id_histori`,`id_transaksi`,`jenis_pembayaran`,`jumlah`,`tanggal_pembayaran`,`keterangan`,`created_at`) values 
(1,14,'DP',5000000.00,'2025-06-26 23:04:18','Pembayaran DP awal','2025-06-28 21:13:41'),
(2,15,'DP',8000000.00,'2025-06-26 23:04:18','Pembayaran DP awal','2025-06-28 21:13:41'),
(3,17,'DP',10000000.00,'2025-06-26 23:04:18','Pembayaran DP awal','2025-06-28 21:13:41'),
(4,18,'DP',12000000.00,'2025-06-26 23:04:18','Pembayaran DP awal','2025-06-28 21:13:41'),
(8,1,'Lunas',1100000.00,'2025-06-26 23:04:18','Pembayaran lunas','2025-06-28 21:13:41'),
(9,2,'Lunas',1250000.00,'2025-06-26 23:04:18','Pembayaran lunas','2025-06-28 21:13:41'),
(10,3,'Lunas',675000.00,'2025-06-26 23:04:18','Pembayaran lunas','2025-06-28 21:13:41'),
(11,4,'Lunas',1700000.00,'2025-06-26 23:04:18','Pembayaran lunas','2025-06-28 21:13:41'),
(12,5,'Lunas',1175000.00,'2025-06-26 23:04:18','Pembayaran lunas','2025-06-28 21:13:41'),
(13,6,'Lunas',600000.00,'2025-06-26 23:04:18','Pembayaran lunas','2025-06-28 21:13:41'),
(14,7,'Lunas',2450000.00,'2025-06-26 23:04:18','Pembayaran lunas','2025-06-28 21:13:41'),
(15,8,'Lunas',2100000.00,'2025-06-26 23:04:18','Pembayaran lunas','2025-06-28 21:13:41'),
(16,9,'Lunas',3900000.00,'2025-06-26 23:04:18','Pembayaran lunas','2025-06-28 21:13:41'),
(17,10,'Lunas',4175000.00,'2025-06-26 23:04:18','Pembayaran lunas','2025-06-28 21:13:41'),
(18,11,'Lunas',6400000.00,'2025-06-26 23:04:18','Pembayaran lunas','2025-06-28 21:13:41'),
(19,12,'Lunas',6550000.00,'2025-06-26 23:04:18','Pembayaran lunas','2025-06-28 21:13:41'),
(20,13,'Lunas',11000000.00,'2025-06-26 23:04:18','Pembayaran lunas','2025-06-28 21:13:41'),
(21,16,'Lunas',8500000.00,'2025-06-26 23:04:18','Pembayaran lunas','2025-06-28 21:13:41'),
(22,24,'Lunas',952000.00,'2025-06-27 00:55:10','Pembayaran lunas','2025-06-28 21:13:41'),
(23,26,'Lunas',1580000.00,'2025-06-27 02:43:43','Pembayaran lunas','2025-06-28 21:13:41'),
(24,27,'Lunas',1452000.00,'2025-06-27 02:44:31','Pembayaran lunas','2025-06-28 21:13:41'),
(25,29,'Lunas',1505000.00,'2025-06-27 11:32:09','Pembayaran lunas','2025-06-28 21:13:41'),
(26,30,'Lunas',940000.00,'2025-06-27 12:37:31','Pembayaran lunas','2025-06-28 21:13:41'),
(42,31,'DP',530000.00,'2025-06-28 21:35:17','Pembayaran DP awal','2025-06-28 21:35:17'),
...
CREATE TABLE `mobil` (
  ...
  `plat_nomor` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `warna` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `penumpang` (
  ...
  `nama_penumpang` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `alamat` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `no_telp` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `penyewa` (
  ...
  `nama_penyewa` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `alamat` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `no_telp` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `no_ktp` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `tipe_biaya` (
  ...
  `nama_tipe` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_tipe`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `transaksi` (
  ...
  `status_pembayaran` enum('Lunas','DP') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `jumlah_dp` decimal(10,2) DEFAULT '0.00',
  `sisa_pembayaran` decimal(10,2) DEFAULT '0.00',
  `status_sewa` enum('Berlangsung','Selesai') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Berlangsung',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
insert  into `transaksi`(`id_transaksi`,`id_penyewa`,`id_mobil`,`id_driver`,`id_penumpang`,`tujuan_sewa`,`tanggal_mulai`,`tanggal_selesai`,`total_hari`,`day`,`harga_mobil`,`harga_driver`,`total_biaya_tambahan`,`total_keseluruhan`,`status_pembayaran`,`jumlah_dp`,`sisa_pembayaran`,`status_sewa`,`created_at`) values 
(1,1,1,1,1,'Jakarta','2024-01-01 10:00:00','2024-01-03 10:00:00','2 Hari',2,700000.00,300000.00,100000.00,1100000.00,'Lunas',0.00,0.00,'Selesai','2025-06-26 23:04:18'),
(2,2,2,2,2,'Bandung','2024-01-05 09:00:00','2024-01-07 09:00:00','2 Hari',2,800000.00,300000.00,150000.00,1250000.00,'Lunas',0.00,0.00,'Selesai','2025-06-26 23:04:18'),
(3,3,3,NULL,NULL,'Surabaya','2024-01-10 08:00:00','2024-01-12 08:00:00','2 Hari',2,600000.00,0.00,75000.00,675000.00,'Lunas',0.00,0.00,'Selesai','2025-06-26 23:04:18'),
(4,4,4,3,3,'Semarang','2024-01-15 11:00:00','2024-01-18 11:00:00','3 Hari',3,1050000.00,450000.00,200000.00,1700000.00,'Lunas',0.00,0.00,'Selesai','2025-06-26 23:04:18'),
(5,5,5,4,4,'Yogyakarta','2024-01-20 13:00:00','2024-01-22 13:00:00','2 Hari',2,750000.00,300000.00,125000.00,1175000.00,'Lunas',0.00,0.00,'Selesai','2025-06-26 23:04:18'),
(6,1,1,1,1,'Jakarta','2025-01-05 10:00:00','2025-01-06 10:00:00','1 Hari',1,350000.00,150000.00,100000.00,600000.00,'Lunas',0.00,0.00,'Selesai','2025-06-26 23:04:18'),
(7,2,2,2,2,'Bandung','2025-01-10 09:00:00','2025-01-14 09:00:00','4 Hari',4,1600000.00,600000.00,250000.00,2450000.00,'Lunas',0.00,0.00,'Selesai','2025-06-26 23:04:18'),
(8,3,3,NULL,NULL,'Surabaya','2025-01-15 08:00:00','2025-01-21 08:00:00','6 Hari',6,1800000.00,0.00,300000.00,2100000.00,'Lunas',0.00,0.00,'Selesai','2025-06-26 23:04:18'),
(9,4,4,3,3,'Semarang','2025-01-20 11:00:00','2025-01-27 11:00:00','7 Hari',7,2450000.00,1050000.00,400000.00,3900000.00,'Lunas',0.00,0.00,'Selesai','2025-06-26 23:04:18'),
(10,5,5,4,4,'Yogyakarta','2025-02-01 13:00:00','2025-02-08 13:00:00','7 Hari',7,2625000.00,1050000.00,500000.00,4175000.00,'Lunas',0.00,0.00,'Selesai','2025-06-26 23:04:18'),
(11,1,2,NULL,NULL,'Jakarta','2025-02-10 10:00:00','2025-02-24 10:00:00','14 Hari',14,5600000.00,0.00,800000.00,6400000.00,'Lunas',0.00,0.00,'Selesai','2025-06-26 23:04:18'),
(12,2,3,5,5,'Bandung','2025-02-15 09:00:00','2025-02-28 09:00:00','13 Hari',13,3900000.00,1950000.00,700000.00,6550000.00,'Lunas',0.00,0.00,'Selesai','2025-06-26 23:04:18'),
(13,3,4,1,1,'Surabaya','2025-03-01 08:00:00','2025-03-21 08:00:00','20 Hari',20,7000000.00,3000000.00,1000000.00,11000000.00,'Lunas',0.00,0.00,'Selesai','2025-06-26 23:04:18'),
(14,4,1,2,2,'Semarang','2025-03-05 11:00:00','2025-03-26 11:00:00','21 Hari',21,7350000.00,3150000.00,1200000.00,11700000.00,'DP',5000000.00,6700000.00,'Berlangsung','2025-06-26 23:04:18'),
(15,5,2,3,3,'Yogyakarta','2025-04-01 13:00:00','2025-04-30 13:00:00','29 Hari',29,11600000.00,4350000.00,1500000.00,17450000.00,'DP',8000000.00,9450000.00,'Berlangsung','2025-06-26 23:04:18'),
(16,1,3,NULL,NULL,'Surabaya','2025-04-05 10:00:00','2025-04-30 10:00:00','25 Hari',25,7500000.00,0.00,1000000.00,8500000.00,'Lunas',0.00,0.00,'Selesai','2025-06-26 23:04:18'),
(17,2,4,4,4,'Bandung','2025-05-01 09:00:00','2025-06-15 09:00:00','45 Hari',45,15750000.00,6750000.00,2000000.00,24500000.00,'DP',10000000.00,14500000.00,'Berlangsung','2025-06-26 23:04:18'),
(18,3,5,5,5,'Yogyakarta','2025-05-15 08:00:00','2025-06-30 08:00:00','45 Hari',45,16875000.00,6750000.00,2200000.00,25825000.00,'DP',12000000.00,13825000.00,'Berlangsung','2025-06-26 23:04:18'),
(24,3,6,6,6,'Medan','2025-06-27 00:54:00','2025-06-30 00:54:00','3 Hari',3,600000.00,300000.00,52000.00,952000.00,'Lunas',0.00,0.00,'Selesai','2025-06-27 00:55:10'),
(26,7,6,2,2,'Medan','2025-06-27 02:42:00','2025-06-30 02:43:00','3 Hari',3,600000.00,450000.00,530000.00,1580000.00,'Lunas',0.00,0.00,'Selesai','2025-06-27 02:43:43'),
(27,1,1,6,6,'Jakarta','2025-06-27 02:44:00','2025-06-30 02:44:00','3 Hari',3,1050000.00,300000.00,102000.00,1452000.00,'Lunas',0.00,0.00,'Selesai','2025-06-27 02:44:31'),
(29,6,1,6,6,'Surabaya','2025-06-27 11:31:00','2025-06-30 11:31:00','3 Hari',3,1050000.00,300000.00,155000.00,1505000.00,'Lunas',0.00,0.00,'Selesai','2025-06-27 11:32:09'),
